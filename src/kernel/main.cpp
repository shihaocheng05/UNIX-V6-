...
extern "C" void next()
{
	...
	m_pAllocator.Page[0x400]=1;	//0#PPDA
	Process* pProcZero = &(Kernel::Instance().GetProcessManager().process[0]);
	pProcZero->p_pgTable=&(Machine::Instance().GetPageDirectory());		//初始化0#进程的p_pgTable表项
